...
**We are in the process of releasing Mapsforge 0.5.2. Please check our release candidates for any issues. See the [changelog](docs/Changelog.md) for details, [download official 0.5.2 binaries](docs/Downloads.md).**
