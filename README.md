...
**We are in the process of releasing Mapsforge 0.5.1. Please check our release candidates for any issues. See the [changelog](docs/Changelog.md) for details, [download official 0.5.1 binaries](docs/Downloads.md).**

**The current stable release is 0.5.0. See the [changelog](docs/Changelog.md) for details, [download official 0.5.0 binaries](docs/Downloads.md).**
