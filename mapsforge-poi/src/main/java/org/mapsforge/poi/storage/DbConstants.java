...
public final class DbConstants {
    ...
    public static final String DROP_CATEGORY_MAP_IDX_STATEMENT = "DROP INDEX IF EXISTS poi_category_map_idx;";
    public static final String DROP_DATA_STATEMENT = "DROP TABLE IF EXISTS poi_data;";
    public static final String DROP_DATA_FTS_STATEMENT = "DROP TABLE IF EXISTS poi_data_fts;";
    ...
    public static final String FIND_IN_BOX_CLAUSE_SELECT =
            "SELECT poi_index.id, poi_index.minLat, poi_index.minLon, poi_data.data "
                    + "FROM poi_index ";
    ...
    public static final String INSERT_DATA_FTS_REBUILD_STATEMENT = "INSERT INTO poi_data_fts(poi_data_fts) VALUES ('rebuild');";
    public static final String INSERT_DATA_FTS_OPTIMIZE_STATEMENT = "INSERT INTO poi_data_fts(poi_data_fts) VALUES ('optimize');";
    public static final String INSERT_DATA_FTS_INTEGRITY_CHECK_STATEMENT = "INSERT INTO poi_data_fts(poi_data_fts, rank) VALUES ('integrity-check', 1);";
