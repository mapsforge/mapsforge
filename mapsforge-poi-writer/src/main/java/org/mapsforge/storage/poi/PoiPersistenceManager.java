...
public interface PoiPersistenceManager {
	 ...
	 *         given position.
	 */
	Collection<PointOfInterest> findNearPosition(GeoCoordinate point,
	 ...
	 */
	Collection<PointOfInterest> findInRect(GeoCoordinate p1,
	 ...
	 *         in the rectangle specified by the two given {@link GeoCoordinate}s.
	 */
	Collection<PointOfInterest> findInRectWithFilter(GeoCoordinate p1,
