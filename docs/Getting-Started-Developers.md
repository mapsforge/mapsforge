...
* In the dialog that opens, go to `Java Build Path Order and Export`. Make sure the entry for `M2_REPO/android/android/5.0.1_r2/android-5.0.1_r2.jar` is unchecked and all others are checked.
