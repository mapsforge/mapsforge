...
import org.mapsforge.map.layer.hills.ClearAsymmetryShadingAlgorithm;
...
public final class Samples {
    ...
    public static void main(String[] args) {
        ...
        if (demFolder != null) {
            MemoryCachingHgtReaderTileSource tileSource = new MemoryCachingHgtReaderTileSource(new DemFolderFS(demFolder), new ClearAsymmetryShadingAlgorithm(), AwtGraphicFactory.INSTANCE);
