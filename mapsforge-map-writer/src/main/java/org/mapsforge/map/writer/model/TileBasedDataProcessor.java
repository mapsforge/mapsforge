...
public interface TileBasedDataProcessor {
     ...
     *
     * @param tc the coordinate of the tile
     ...
     *
     * @param outerWayID id of the outer way
     ...
     *
     * @param baseZoomIndex   index of the base zoom, as defined in a ZoomIntervalConfiguration
     * @param tileCoordinateX x coordinate of the tile
     * @param tileCoordinateY y coordinate of the tile
     ...
     *
     * @param zoomIntervalIndex the index of the zoom interval
    ...
    /**
     * @return the count of added nodes
     */
    int getNodeCount();

    /**
     * @return the count of added relations
     */
    int getRelationCount();

    /**
     * @return the count of added ways
     */
    int getWayCount();
}
