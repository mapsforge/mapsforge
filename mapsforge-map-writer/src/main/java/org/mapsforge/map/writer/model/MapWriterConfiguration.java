...
public class MapWriterConfiguration {
     ...
     * Convenience method.
     *
     * @param encoding the choice for the encoding, either auto, single or double are valid parameters
     */
     ...
     * Convenience method.
     *
     * @param position the map start position in format latitude, longitude
     */
     ...
     * Convenience method.
     *
     * @param zoom the map start zoom level
     */
     ...
     * Convenience method.
     *
     * @param zoomIntervalConfiguaration the zoom interval configuration
     */
    ...
    /**
     * @param bboxEnlargement the bboxEnlargement to set
     */
    ...
    /**
     * @param dataProcessorType the dataProcessorType to set
     */
    ...
    /**
     * @param debugStrings the debugStrings to set
     */
    ...
    /**
     * @param encodingChoice the encodingChoice to set
     */
    ...
    /**
     * @param fileSpecificationVersion the fileSpecificationVersion to set
     */
    ...
    /**
     * @param mapStartPosition the mapStartPosition to set
     */
    ...
    /**
     * @param mapStartZoomLevel the mapStartZoomLevel to set
     */
    ...
    /**
     * @param polygonClipping the polygonClipping to set
     */
    ...
    /**
     * @param progressLogs the progress logs to set
     */
    ...
    /**
     * @param skipInvalidRelations the skipInvalidRelations to set
     */
    ...
    /**
     * @param wayClipping the wayClipping to set
     */
    ...
    /**
     * @param zoomIntervalConfiguration the zoomIntervalConfiguration to set
     */
