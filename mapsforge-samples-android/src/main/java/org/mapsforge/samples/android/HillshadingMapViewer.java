...
public class HillshadingMapViewer extends DefaultTheme {
    ...
    final static String demFolderKey = "demFolderUri";
    final static String demUseFiles = "demFolderFiles";
    final static int idHillshadingDemSelect = R.id.hillshading_dem_select;
    @Override
    ...
    private void startSelect() {
        ...
        startActivityForResult(intent, idHillshadingDemSelect);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode==idHillshadingDemSelect) try {
